"""Makryvelios Research Analytics & Econometrics Workbench v5.2.1.
...
<div class="hero"><span class="status">POSTDOCTORAL ANALYTICAL ENGINE v5.2.1 · SYSTEM ONLINE</span><h1>Makryvelios Research Analytics &amp; Econometrics Command Centre</h1><p>R&amp;D projects • «Αντώνης Τρίτσης» • renewable-energy portfolios • causal and predictive econometrics • Monte Carlo • advanced clustering • MCDA • panel models • Greece spatial intelligence • publication systems</p><span class="chip">OLS + causal inference</span><span class="chip">Monte Carlo</span><span class="chip">Advanced clustering</span><span class="chip">Dedicated MCDA</span><span class="chip">Panel FE / RE</span><span class="chip">Predictive validation</span><span class="chip">600-dpi + vector output</span></div>
...
if page == "1. Executive overview":
    ...
    st.caption("The app never sends uploaded datasets to an external analytics API. Eurostat GISCO is contacted only to retrieve public map boundaries unless a custom GeoJSON is supplied.")

    st.subheader("Version 5.2.1 documentation library")
    st.info("The consolidated report covers installation, all eighteen modules, econometric interpretation, MCDA methodology, publication outputs, validation, troubleshooting, reproducibility and requirements traceability.")
    documentation_files = [
