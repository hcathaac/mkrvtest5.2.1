...
1. Download and extract `Makryvelios_Research_Analytics_v5_2_1.zip`.
...
4. Confirm that `makryvelios_dashboard_v2/app.py`, `analytics_core.py`, `advanced_analytics.py`, `mcda.py`, `visuals.py`, `requirements.txt`, `source_evidence_catalogue.csv`, the `documentation` folder and the `data` folder are present.
...
- The dark blue/cyan high-technology header marked **POSTDOCTORAL ANALYTICAL ENGINE v5.2.1**.
...
- Eighteen analytical modules in total.
